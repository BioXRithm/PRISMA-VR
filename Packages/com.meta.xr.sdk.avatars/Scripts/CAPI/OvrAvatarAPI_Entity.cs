...
namespace Oculus.Avatar2
{
    ...
    public static partial class CAPI
    {
        ...
        /// @ovrAvatar2EntitySubMeshVertexPreference
        /// @ovrAvatar2EntitySubMeshInclusionFlags
        /// @ovrAvatar2EntityQuality
        ///
        [System.Serializable]
        ...
        public unsafe struct ovrAvatar2EntityFilters
        {
            ...
            public ovrAvatar2EntitySubMeshVertexPreference subMeshVertexPreference; // unsigned  ovrAvatar2EntitySubMeshVertexPreference
        }
        ...
        public static ovrAvatar2EntityFilters OvrAvatar2_DefaultLoadFilters => new ovrAvatar2EntityFilters
        {
            ...
            subMeshVertexPreference = ovrAvatar2EntitySubMeshVertexPreference.Default,
        ...
        internal static bool OvrAvatar2Entity_UnloadMemory(ovrAvatar2EntityId entityId, string name)
        {
            unsafe
            {
                using var stringAllocHandle = new StringHelpers.StringViewAllocHandle(name, Allocator.Persistent);
                return ovrAvatar2Entity_UnloadMemory(entityId, (char*)stringAllocHandle.StringView.data)
                    .EnsureSuccess("ovrAvatar2Entity_UnloadMemory");
            }
        }
