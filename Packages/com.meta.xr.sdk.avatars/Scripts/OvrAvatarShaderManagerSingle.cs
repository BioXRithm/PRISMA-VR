...
namespace Oculus.Avatar2
{
    ...
    public class OvrAvatarShaderManagerSingle : OvrAvatarShaderManagerBase
    {
        ...
        [SerializeField] protected OvrAvatarShaderConfiguration? CelShaderConfigurationInitializer = null;
        ...
        protected override OvrAvatarShaderConfiguration _FindConfiguration(ShaderType type)
        {
            ...
            // Don't check if the cel initializer is null because it's possible to use this manager without cel support
            ...
            switch (type)
            {
                ...
                case ShaderType.Cel:
                    return CelShaderConfigurationInitializer!;
            }
        ...
        protected override void _AutoGenerateMissingShaderConfigurations()
        {
            ...
            InitializeAutoGeneratedConfiguration(ref CelShaderConfigurationInitializer);
        }
    }
}
